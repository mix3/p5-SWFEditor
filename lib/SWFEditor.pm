...
# This allows declaration	use SWFEditor ':all';
...
my $SHAPE_BITMAP_NONE           = 0;
my $SHAPE_BITMAP_MATRIX_RESCALE = 1;
my $SHAPE_BITMAP_RECT_RESIZE    = 2;
my $SHAPE_BITMAP_TYPE_TILLED    = 4;
